...
if (localStorage.getItem("name")== "saysopensesame"+ "'s Bakery"){
  localStorage.setItem("score",10000000000000000000000000000000000000000000);
document.getElementById("score").innerHTML = localStorage.getItem("score");
}
myNewPlayer();
...
function myRebirth() {
  ...
  if (answer3 == "yes" && localStorage.getItem("score") >= 250000000 * localStorage.getItem("recost")) {
    ...
    //increased multi
    localStorage.setItem("multi", Number(localStorage.getItem("multi")) + 45);
    document.getElementById("multi").innerHTML = localStorage.getItem("multi") + "%";
